package com.supersmack.controllers.ui;
...
public class SSViewPagerIndicator extends RelativeLayout implements OnPageChangeListener {
	...
	public SSViewPagerIndicator(Context context, AttributeSet attrs) {
		super(context, attrs);
		addContent();
	}
	
	public SSViewPagerIndicator(Context context, AttributeSet attrs, int defStyle){
		super(context, attrs, defStyle);
		addContent();
	}
	
	public SSViewPagerIndicator(Context context) {
		super(context);
		addContent();
	}
	...
	class OnPreviousClickedListener implements android.view.View.OnClickListener{
		...
		public void onClick(View v) {
			if(mOnClickHandler != null){
				mOnClickHandler.onPreviousClicked(SSViewPagerIndicator.this);
			}
		}
	}
	class OnCurrentClickedListener implements android.view.View.OnClickListener{
		...
		public void onClick(View v) {
			if(mOnClickHandler != null){
				mOnClickHandler.onCurrentClicked(SSViewPagerIndicator.this);
			}
		}
	}
	class OnNextClickedListener implements android.view.View.OnClickListener{
		...
		public void onClick(View v) {
			if(mOnClickHandler != null){
				mOnClickHandler.onNextClicked(SSViewPagerIndicator.this);
			}
		}
	}
}
